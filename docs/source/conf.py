...
github_repository = "askhelmut"

language = "en"

ogp_site_name = "askhelmut"
ogp_image = "https://askhelmut.readthedocs.io/en/latest/_static/logo.png"
ogp_custom_meta_tags = [
    '<meta name="twitter:card" content="askhelmut" />',
]
...
html_theme_options = {
    "announcement": (
        '<a target="_blank" href="https://github.com/helmut-hoffer-von-ankershoffen/askhelmut">GitHub</a> - '
        '<a target="_blank" href="https://pypi.org/project/askhelmut">PyPI</a> - '
        '<a target="_blank" href="https://hub.docker.com/r/helmuthva/askhelmut/tags">Docker</a> - '
        '<a target="_blank" href="https://sonarcloud.io/summary/new_code?id=helmut-hoffer-von-ankershoffen_askhelmut">SonarQube</a> - '  # noqa: E501
        '<a target="_blank" href="https://app.codecov.io/gh/helmut-hoffer-von-ankershoffen/askhelmut">Codecov</a>'
    ),
}
